...
<body>
<form class="layui-form" action="/acct/transfer" method="post">

    <div class="layui-form-item">
        <label class="layui-form-label">付款账号：</label>
        <div class="layui-input-inline">
            <input type="text" name="payCardId" style="display:none">
            <input type="text" name="payCardId" required lay-verify="required|number" placeholder="请输入付款账号"
                   autocomplete="off"
                   class="layui-input">
        </div>
    </div>
...
<script type="text/javascript" src="/src/js/transfer.js"></script>
</body>
</html>